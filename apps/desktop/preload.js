...
contextBridge.exposeInMainWorld("copypasteProtocol", {
  ...
  buildRoadmapGptRevisionPrompt: (project, appliedMasterPlan, currentRoadmapDraft, claudeResponseOrNull, userFeedback) => projectBuilderProtocol.buildRoadmapGptRevisionPrompt(project, appliedMasterPlan, currentRoadmapDraft, claudeResponseOrNull, userFeedback),
  buildTaskClaudeImprovePrompt: (project, activeMasterPlan, savedRoadmap, taskPrompt, roadmapItem, userFeedback, runHistory) => projectBuilderProtocol.buildTaskClaudeImprovePrompt(project, activeMasterPlan, savedRoadmap, taskPrompt, roadmapItem, userFeedback, runHistory),
  buildTaskGptRevisionPrompt: (project, activeMasterPlan, savedRoadmap, taskPrompt, roadmapItem, claudeResponseOrNull, userFeedback, runHistory) => projectBuilderProtocol.buildTaskGptRevisionPrompt(project, activeMasterPlan, savedRoadmap, taskPrompt, roadmapItem, claudeResponseOrNull, userFeedback, runHistory),
...
// Legacy alias retained only because the active renderer still calls it in two copy flows.
