...
- Desktop main also records the single pending extension request and fills missing response metadata as a compatibility fallback for an unpacked extension that has not been reloaded after the requestId bridge change.
